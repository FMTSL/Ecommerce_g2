package com.ecommerce.NutriCommunity.configuration;
...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.apis(RequestHandlerSelectors
						.basePackage("com.ecommerce.NutriCommunity.controller"))
	...
	public static ApiInfo metadata() {
		return new ApiInfoBuilder()
				.title("API - Ecommerce")
				.description("Projeto API Spring - Nutri Community")
				.version("1.0.0")
				.license("Apache License Version 2.0")
				.licenseUrl("https://github.com/FMTSL/Ecommerce_g2")
				.contact(contact())
				.build();
	}
	
	private static Contact contact() {
		return new Contact("Giovanna S. P. dos Penedos", "https://github.com/FMTSL/Ecommerce_g2", "giovanna.penedos@outlook.com");
	}
